...
class Googlemaps {
	...
	public $center						= "37.4419, -122.1419";
	public $disableDefaultUI			= FALSE;
	public $disableMapTypeControl		= FALSE;
	public $disableNavigationControl	= FALSE;
	public $disableScaleControl		= FALSE;
	public $disableDoubleClickZoom		= FALSE;
	public $draggable					= TRUE;
	public $draggableCursor			= '';
	public $draggingCursor				= '';
	public $navigationControlPosition	= '';
	...
	public $mapTypeControlPosition		= '';
	public $region						= '';
	public $scaleControlPosition		= '';
